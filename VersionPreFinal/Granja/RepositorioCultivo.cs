     ...
     #region Properties  
        ...
        public List<Seccion> CrearSecciones()
        {
            ...
            secciones.Add(new Seccion()
            {
                ...
                ProduccionFrutas = 10000,
                ProduccionDinero = 870000,
                enDomo = false,
                LuzArtificial = false
            });
            secciones.Add(new Seccion()
            {
                ...
                ProduccionFrutas = 8000,
                ProduccionDinero = 720000,
                enDomo = false,
                LuzArtificial = false
            });
            secciones.Add(new Seccion()
            {
                ...
                ProduccionFrutas = 1000,
                ProduccionDinero = 130000,
                enDomo = false,
                LuzArtificial = false
            });
            return secciones;
